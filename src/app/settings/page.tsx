        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg border border-gray-200 bg-white px-4 py-3 shadow-sm">
            ...
            <p className="mt-1 text-xs text-gray-600">
              ...
              <span className="font-mono text-[11px]">LOOPS_SEND_TO</span> until per-user routing is stored in the
              database.
            </p>
            <div className="mt-3 flex flex-wrap items-center gap-4">
              <label className="flex cursor-pointer items-center gap-2 text-sm text-gray-800">
                <input
                  ...
                  onChange={(e) =>
                    setDailyDigestPrefs((p) => ({ ...p, emailDigest: e.target.checked }))
                  }
                />
                Email daily brief
              </label>
          ...
          <div className="rounded-lg border border-dashed border-gray-200 bg-gray-50/80 px-4 py-3">
            ...
            <p className="mt-1 text-xs text-gray-600">
              “Still in To-Do” uses this browser’s saved list of surfaced vs opened actions. Clear it if demos get
              confusing.
            </p>
            <button
              type="button"
