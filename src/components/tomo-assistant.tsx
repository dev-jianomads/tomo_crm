    ...
    <div className="flex h-full flex-col rounded-md border border-gray-200 bg-white">
      ...
      {suggestions.length ? (
        <div className="flex flex-wrap gap-2 border-t border-gray-100 px-4 py-2">
          {/*
            Suggestion chips are context-aware
            PRODUCTION: These could be dynamically generated by Tomo AI
            based on the current context (e.g., "Draft follow-up" when viewing a contact)
          */}
