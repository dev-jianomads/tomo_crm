...
function generateRelationships(): Relationship[] {
  ...
  const scenarioLps: Partial<Relationship>[] = [
    ...
    {
      name: "Michel del Buono",
      firm: "A16z Family Office",
      ...
      source: "Warm intro",
      sourceDetail: "Liyen Chow — Goldman Sachs cap intro",
      lastFundHistory: "New prospect",
      decisionTimeline: "Q3",
      fiscalYearEnd: "Dec",
      consultantDependent: "Direct",
      esgRequired: "Unknown",
      nextMove: "Send intro reply within 24h",
      openLoops: 1,
      band: "Heating Up",
    ...
    },
    {
      ...
      consultantDependent: "Direct",
      esgRequired: "No",
      nextMove: "Confirm meeting for new fund launch",
      openLoops: 2,
      band: "Active-Stable",
      lastMeetingDate: "2025-02-20",
      contactSeniority: "CIO",
    },
    {
      name: "Camille Durand",
...
export const actions: ActionItem[] = [
  ...
  {
    id: "a2",
    title: "GS Cap Intro: Michel del Buono A16z Family Office",
    attentionCard: {
      company: "Goldman Sachs (intro)",
      contactName: "Michel del Buono",
      verb: "Approve",
      workKind: "Introduction",
      workSubject: "A16z Family Office — reply due",
    },
    status: "approval",
  ...
  },
  {
    ...
    status: "blocked",
    trigger: "You did not approve and send TOMO's email summary and next steps",
    evidence: [
      "Meeting with James Staltari yesterday — last touch felt positive.",
      "Email summary / thanks required within 2 hours (SLA) — now overdue.",
      "(1) Review and approve draft (2) Add tasks to CRM (3) Schedule James + your COO within 2 weeks.",
    ],
    type: "follow_up",
    suggestedUpdates: [
